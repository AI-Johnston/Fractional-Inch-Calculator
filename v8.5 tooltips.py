...
from tooltips import ToolTip #For tooltips
...
class Calculator:
    ...
    def __init__(self, master):
        ...
        ToolTip(self.feet_entry, msg="Enter the number of feet (whole number).")
        ...
        ToolTip(self.inches_entry, msg="Enter the number of inches (whole number).")
        ...
        ToolTip(self.fraction_entry, msg="Enter the fractional part of an inch (e.g., 1/2, 3/4).")
        ...
        ToolTip(self.feet_entry2, msg="Enter the number of feet (whole number).")
        ...
        ToolTip(self.inches_entry2, msg="Enter the number of inches (whole number).")
        ...
        ToolTip(self.fraction_entry2, msg="Enter the fractional part of an inch (e.g., 1/2, 3/4).")
        ...
        ToolTip(self.add_button, msg="Add Measurement 1 and Measurement 2.")
        ...
        ToolTip(self.subtract_button, msg="Subtract Measurement 2 from Measurement 1.")
        ...
        ToolTip(self.multiply_button, msg="Multiply Measurement 1 and Measurement 2.")
        ...
        ToolTip(self.divide_button, msg="Divide Measurement 1 by Measurement 2.")
        ...
        ToolTip(self.clear_button, msg="Clear the input fields.")
        ...
        ToolTip(self.reset_button, msg="Clear the input fields and the calculation log.")
        ...
        ToolTip(self.copy_button, msg="Copy the result to the clipboard.")
        ...
        for button_text in numbers:
            button = ttk.Button(self.number_pad_frame, text=button_text, width=4,
                       command=lambda text=button_text: self.insert_text(text))
            button.grid(row=row_val, column=col_val)
            ToolTip(button, msg=f"Insert {button_text}")
            col_val += 1
            if col_val > 2:
                col_val = 0
                row_val += 1
