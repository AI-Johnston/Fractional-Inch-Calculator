...
class Calculator:
    def __init__(self, master):
        ...
        self.feet_entry = ttk.Entry(self.measurement1_frame, width=10, validate="key",
        ...
        self.inches_entry = ttk.Entry(self.measurement1_frame, width=10, validate="key",
                                      validatecommand=(master.register(self.validate_integer_input), "%P"),
        ...
        self.fraction_entry = ttk.Entry(self.measurement1_frame, width=10, validate="key",
        ...
        self.feet_entry2 = ttk.Entry(self.measurement2_frame, width=10, validate="key",
                                     validatecommand=(master.register(self.validate_integer_input), "%P"),
        ...
        self.inches_entry2 = ttk.Entry(self.measurement2_frame, width=10, validate="key",
                                       validatecommand=(master.register(self.validate_integer_input), "%P"),
        ...
        self.fraction_entry2 = ttk.Entry(self.measurement2_frame, width=10, validate="key",
                                         validatecommand=(master.register(self.validate_fraction_input), "%P"),
